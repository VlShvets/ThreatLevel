...
struct Area
{
    ...
    QVector <int>   numTrack;           /// Массив номеров идентифицированных с ПР трасс
    ...
    static int  detectTracksCount;      /// Количество обнаруженных не идентифицированных ни с каким ПР трасс в текущий момент
    static int  idenTracksMaxCount;     /// Максимальное количество идентифицированных с каким-либо ПР трасс в текущий момент
