...
TrackParameters::TrackParameters(QWidget *parent) : QWidget(parent)
{
    ...
    sliderGroup->setRange(1, MAX_NUM_GROUPS);
    sliderGroup->setTickInterval(1);
    sliderGroup->setValue(DEF_NUM_GROUPS);
    ...
    lNumGroups->display(DEF_NUM_GROUPS);
    ...
    sliderTrack->setRange(1, MAX_TRACKS_IN_GROUP);
    sliderTrack->setTickInterval(1);
    sliderTrack->setValue(DEF_TRACKS_IN_GROUP);
    ...
    lTracksInGroup->display(DEF_TRACKS_IN_GROUP);
    ...
    tTrackPar = new QTableWidget(DEF_NUM_GROUPS * DEF_TRACKS_IN_GROUP, 6, this);
    tTrackPar->setHorizontalHeaderLabels(QStringList() << "Координата X" << "Координата Y" << "Курс (град.)" <<
                                         "Скорость" << "Ускорение" << "БЦ");
    gridLayout->addWidget(tTrackPar, 3, 0, 1, 3);

    this->setLayout(gridLayout);

    initPar(DEF_NUM_GROUPS, DEF_TRACKS_IN_GROUP);
}
...
void TrackParameters::initPar(int _nGroups, int _nTracksInGroup)
{
    for(int i = 0; i < _nTracksInGroup; ++i)
    {
        ...
        case 10:
            /// Группа трасс №10
            tTrackPar->setItem(_nGroups * i + 9, 0, new QTableWidgetItem(QString::number(-180000.0 - DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 9, 1, new QTableWidgetItem(QString::number(-440000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 9, 5, new QTableWidgetItem(QString::number(1)));

        case 9:
            /// Группа трасс №9
            tTrackPar->setItem(_nGroups * i + 8, 0, new QTableWidgetItem(QString::number(180000.0 + DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 8, 1, new QTableWidgetItem(QString::number(-440000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 8, 5, new QTableWidgetItem(QString::number(0)));

        case 8:
            /// Группа трасс №8
            tTrackPar->setItem(_nGroups * i + 7, 0, new QTableWidgetItem(QString::number(350000.0 + DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 7, 1, new QTableWidgetItem(QString::number(-350000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 7, 5, new QTableWidgetItem(QString::number(0)));

        case 7:
            /// Группа трасс №7
            tTrackPar->setItem(_nGroups * i + 6, 0, new QTableWidgetItem(QString::number(-400000.0 - DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 6, 1, new QTableWidgetItem(QString::number(-400000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 6, 5, new QTableWidgetItem(QString::number(0)));

        case 6:
            /// Группа трасс №6
            tTrackPar->setItem(_nGroups * i + 5, 0, new QTableWidgetItem(QString::number(0.0 + DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 5, 1, new QTableWidgetItem(QString::number(-400000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 5, 5, new QTableWidgetItem(QString::number(0)));

        case 5:
            /// Группа трасс №5
            tTrackPar->setItem(_nGroups * i + 4, 0, new QTableWidgetItem(QString::number(-160000.0 - DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 4, 1, new QTableWidgetItem(QString::number(-390000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 4, 5, new QTableWidgetItem(QString::number(0)));

        case 4:
            /// Группа трасс №4
            tTrackPar->setItem(_nGroups * i + 3, 0, new QTableWidgetItem(QString::number(160000.0 + DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 3, 1, new QTableWidgetItem(QString::number(-390000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 3, 5, new QTableWidgetItem(QString::number(0)));

        case 3:
            /// Группа трасс №3
            tTrackPar->setItem(_nGroups * i + 2, 0, new QTableWidgetItem(QString::number(300000.0 + DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 2, 1, new QTableWidgetItem(QString::number(-300000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 2, 5, new QTableWidgetItem(QString::number(0)));

        case 2:
            /// Группа трасс №2
            tTrackPar->setItem(_nGroups * i + 1, 0, new QTableWidgetItem(QString::number(-350000.0 - DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i + 1, 1, new QTableWidgetItem(QString::number(-350000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i + 1, 5, new QTableWidgetItem(QString::number(0)));

        case 1:
            /// Группа трасс №1
            tTrackPar->setItem(_nGroups * i, 0, new QTableWidgetItem(QString::number(0.0 + DIST_BETWEEN_TRACKS * (i / 3))));
            tTrackPar->setItem(_nGroups * i, 1, new QTableWidgetItem(QString::number(-350000.0 - DIST_BETWEEN_TRACKS * (i % 3))));
            ...
            tTrackPar->setItem(_nGroups * i, 5, new QTableWidgetItem(QString::number(0)));
